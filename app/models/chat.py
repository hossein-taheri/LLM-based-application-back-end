...
2. If a disease is detected based on the symptoms provided, respond with the following (make "Model's Answer:", "More Information About Disease:" and "Explanation for my detection:" as headers): 
